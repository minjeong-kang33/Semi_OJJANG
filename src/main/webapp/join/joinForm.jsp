		...
		<fieldset class="joinUpField">
			...
			<ul>
				<li><label for="userid">아이디</label> <input type="text"
					id="M_id" name="M_id" size="15" required> <input
					type="button" value="ID중복확인" onclick="idCheck()" id="joinbutton">
				...
				<li><label for="pwd1"> 비밀번호</label> <input type="password"
					id="M_pw" name="M_pw" size="15" required onchange="check_pw()">
				</li>
				<li><label for="pwd2">비밀번호 확인</label> <input type="password"
					id="M_pw2" name="M_pw2" size="15" required onchange="check_pw()">&nbsp;<span
					id="check"></span></li>
			</ul>
		</fieldset>
		...
		<fieldset>
			...
			<ul>
				<li><label for="fullname">이름</label> <input type="text"
					id="M_name" name="M_name" size="15" required></li>
				<li><label for="gender">성별</label> <input type="radio"
					name="M_gender" id="남"> 남 <input type="radio" name="M_gender"
					id="여"> 여 <br></li>
				<li><label for="nickname">닉네임</label> <input type="text"
					id="M_nick" name="M_nick" size="15" required> <input
					type="button" value="중복확인" onclick="nickCheck()" id="joinbutton">
					<script type="text/javascript">
						function nickCheck() {
				...
				<li><label for="email">이메일</label> <input type="email"
					id="M_email" name="M_email" size="30"> <input type="button"
					id="joinbutton" value="이메일 인증"
					onclick="location.href = 'emailSendAction.jsp'"></li>

				<li><label for="phone">전화번호</label> <input type="text"
					id="M_phone" name="M_phone" size="15"></li>
				<li><label for="postcode">우편번호</label> <input type="text"
					id="sample6_postcode" placeholder="우편번호" onclick="DaumPostcode()">
					<input type="button" value="우편번호 찾기" id="joinbutton"></li>
				<li><label for="address">주소</label> <input type="text"
					name="M_address" id="M_address" placeholder="주소"></li>
				<li><label for="address2">상세주소</label> <input type="text"
					name="M_address2" id="M_address2" placeholder="상세주소"></li>
				<%@include file="addressMap.jsp"%>
			</ul>
		</fieldset>
		<fieldset>
			<input type="submit" value="회원가입" id="joinbutton2" /> <input
				type="reset" value="초기화" id="joinbutton3" />
		</fieldset>
	</form>
