...
<!-- 게시판 내용 여기부터 넣으세요  -->
	...
	ArrayList<SellDTO> sellDressList = (ArrayList<SellDTO>)request.getAttribute("sellDressList");
...
<table>
	<tr> <!--  테이블................1칸 -->
	<%
	for(int i=0; i<sellDressList.size();i++){
		SellDTO dto = sellDressList.get(i);
	
	%>
		<td>
			<table class="item-table">
				<tr>
					<td colspan="2" class="S_img"><a href="SellDressDetails.sell?S_num=<%=dto.getS_num()%>" >
					<img src="img/sell/<%=dto.getS_img() %>" width=300px height=300px class="goodsImg"></a></td>
				</tr>
				<tr>
					<td colspan="2" class="S_title" > <a href="SellDressDetails.sell?S_num=<%=dto.getS_num()%>" > <%=dto.getS_title()%></a></td> <!-- 제목 -->
				</tr>
				<tr>
									<tr>
...
<!-- 게시판 내용 여기 넘어가면 안됨.  -->							
			...
			<div style="width: 1000px;">	
				...
				for(int i=startPage;i<=endPage;i++){
					%>
					<a href="Dress.sell?pageNum=<%=i%>"><%=i%></a>
					<%
				}
