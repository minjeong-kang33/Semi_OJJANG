	 ...
	 var area0 = ["시/도 선택안함","서울특별시","인천광역시","대전광역시","광주광역시","대구광역시","울산광역시","부산광역시","경기도","강원도","충청북도","충청남도","전라북도","전라남도","경상북도","경상남도","제주도"];
	  var area1 = ["강남구","강동구","강북구","강서구","관악구","광진구","구로구","금천구","노원구","도봉구","동대문구","동작구","마포구","서대문구","서초구","성동구","성북구","송파구","양천구","영등포구","용산구","은평구","종로구","중구","중랑구"];
	   ...
	   $("select[name^=S_sido1]").each(function() {
		     ...
		     $selS_sido1.next().append("<option value=''>구/군 선택안함</option>");
		    });
		    ...
		    $("select[name^=S_sido1]").change(function() {
		     ...
		     if(area == "area0")
		      $S_gugun1.append("<option value=''>구/군 선택안함</option>");
		     else {
				...
				<div class="col-lg-4">
					<div class="item">
						...
						<div class="SellInert" style="margin-left:200px;width: 800px;">
							<!-- ** 옷 카테고리 선택 시작 -->
							<form id="frm" action="SellInsertPro.sell" method="post" enctype="multipart/form-data" onsubmit="return fun1()">
								<div class="radio1">
									<b style="margin-right: 67px;">카테고리</b>
							     	...
							     	<td colspan="2">
							     		<div style="margin-left: 34px;">
							              ...
							              <div class="button2" style="float: right;margin-right: 110px;">
							            	 <input type="submit" id="save" value="등록" class="btn btn-dark"/>
